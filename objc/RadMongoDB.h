/*!
 @header RadMongoDB.h
 @discussion Declarations for the RadMongoDB component.
 ...
 */
@interface RadMongoDBCursor : NSObject


/*! Step the cursor to the next object. */
- (BOOL) next;
/*! Get the RadBSON representation of the current object. */
- (RadBSON *) currentBSON;
...
/*!
 ...
 @discussion RadMongoDB instances are used to connect to, update, and query MongoDB databases.
 */
@interface RadMongoDB : NSObject
